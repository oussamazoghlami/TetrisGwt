 ...
 * 
 */
public class TetrisElementImpl2 extends TetrisElement {
	
	private static final String CSS_COLOR = "rgb(0,0,0)";

	/**
	 * 
	 * @param context
	 */
	public TetrisElementImpl2(Context2d context) {
	...
	protected void initWidgetPoints() {
		...
		Rectangle rectangle4 = new Rectangle(Rectangle.WIDTH * 4 + 2 * 4, Rectangle.HEIGHT * 2 + 2 * 2, cssColor);
