 ...
 *
 */
public class TetrisElementImpl7 extends TetrisElement {
	
	private static final String CSS_COLOR = "rgb(139,134,78)";

	/**
	 * 
	 * @param context
	 */
	public TetrisElementImpl7(Context2d context) {
	...
	protected void initWidgetPoints() {
		...
		Rectangle rectangle2 = new Rectangle(Rectangle.WIDTH * 4 + 2 * 4, 0, cssColor);
		Rectangle rectangle3 = new Rectangle(Rectangle.WIDTH * 6 + 2 * 6, Rectangle.HEIGHT + 2, cssColor);
